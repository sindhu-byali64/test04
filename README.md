...
The dataset consists of 303 records with 14 attributes related to patient health.
...
Applied feature scaling using StandardScaler to normalize the feature values.
